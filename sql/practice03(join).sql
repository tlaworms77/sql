...
select ti.title as '직책', sal.salary as '급여'
   from employees emp, titles ti, salaries sal 
      where emp.emp_no = sal.emp_no and ti.emp_no = emp.emp_no 
         and sal.to_date ='9999-01-01' and sal.salary > 50000
            order by sal.salary desc;

-- 문제9.
-- 현재, 부서별 평균 연봉을 연봉이 큰 부서 순서대로 출력하세요.
select b.dept_no as "부서",
	   avg(a.salary) as "평균 연봉"
